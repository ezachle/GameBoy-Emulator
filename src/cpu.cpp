...
uint8_t CPU::get_src_reg_u8(uint8_t opcode) {
...
uint8_t* CPU::get_dst_reg_u8(uint8_t opcode) {
...
void CPU::process_instructions(uint16_t pc, InstrInfo_t *instr) {
...
void CPU::process_prefix_instructions(uint8_t opcode) {
